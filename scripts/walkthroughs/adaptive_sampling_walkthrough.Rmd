...
emp_crit <- empirical_criterion[empirical_criterion$observations == 0,]

emp_critind <- sample(1:nrow(emp_crit), 3500) ## how many new locations are visited

### need to compare against the true species distribution to see whether new observations are made
